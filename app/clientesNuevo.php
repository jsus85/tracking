              ...
              <div class="col-xs-12">            
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-12">
                      <input onblur="xajax_comprobar_clave(this.value);" type="text" name="clave" id="clave" class="form-control" placeholder="">
                    </div>
                  </div>
                </div>
              </div>  
              ...
              <div class="col-xs-12">            
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-12">
                      <input type="text" class="form-control" onblur="xajax_comprobar_ruc(this.value);" name="ruc" id="ruc" placeholder="">
                    </div>
                  </div>
                </div>
              </div>  
              ...
              <div class="col-xs-12">            
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-5 col-xs-12">
                      <input type="text" class="form-control" name="telefonos" id="telefonos" placeholder="">
                    </div>
                  </div>
                </div>
              </div>  
                    ...
                    <div class="col-sm-5 col-xs-12">
                      <div class="row">
                        <div class="col-sm-3 col-xs-5">
                          <label>
                            <input type="radio" name="condicion" id="condicion" value="N" checked="">
                            Natural
                          </label>
                        </div>
                        <div class="col-sm-3 col-xs-5">
                          <label>
                            <input type="radio" name="condicion" id="condicion" value="J" checked="">
                            Jurídico
                          </label>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div id="mensaje"></div>
                          <div class="col-sm-3 col-xs-12">
                            <button type="button" onclick="xajax_procesar_formulario(xajax.getFormValues('formpersona'))"  class="btn btn-primary middle">Grabar</button>
                          </div>
                          <div class="col-sm-3 col-xs-12">
