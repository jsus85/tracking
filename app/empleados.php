...
{ 
  ...
  $sqlestado  = db_query("SELECT estado FROM empleados
                                                     WHERE id='".$_GET['id_mod']."'");
  $row        = db_fetch_array($sqlestado);
  
  $estado=($row['estado']=='1')?'0':'1';  

  db_query("UPDATE empleados SET estado = '".$estado."' 
                                                      WHERE id='".$_GET['id_mod']."'");
...
if($_GET['id_del'])
{   
  db_query("DELETE FROM empleados WHERE id='".$_GET['id_del']."'");
//  db_query("DELETE FROM webpermisos WHERE codigo_persona='".$_GET['id_del']."'"); 
  ...
  $sqlPersona= " SELECT * FROM empleados where 1=1 ".$cadFecha.$condi." ORDER BY id desc"; 
...
<head>
  ...
  <title>Alba Transportes - Empleados</title>
...
<div class="panel--box">
  ...
  <div class="panel--body">
    <form name="frm_usuarios" method="post" action="empleados.php">
          ...
          <div class="col-xs-12">
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12 pull-right">
                <div class="select-op">
                  <div class="row">
                    <div class="col-xs-6"><a  href="empleadosNuevo.php"><i class="fa fa-lg fa-fw fa-file-o"></i> NUEVO</a></div>
...
?>
                          ...
                          <tr>
                              ...
                              <td class="text-center"><a href="empleados.php?id_mod=<?php echo $row['id'];?>"><i class="fa fa-fw  <?php echo $estado;?> fa-2x"></i></a></td>
                              <td class="action text-center">
                               <a href="empleadosEditar.php?id_empleados=<?=$row['id']?>" title="Modificar"><i class="fa fa-fw fa-edit fa-2x"></i></a>
                               <a onclick="willSubmit=confirm('&iquest;Esta seguro de eliminar este registro?'); return willSubmit;" href="empleados.php?id_del=<?=$row['id']?>" title="Eliminar"> <i class="fa fa-fw fa-trash-o fa-2x"></i></a>
                              </td>
                          </tr>
<?    }    //while
   }  // else ?>
<?php 
    ...
    ?>
        <tr>
        <td  height="25" colspan="8"><?php include "sisweb_incpaginacion.php"; ?></td>
    </tr>
<?  } ?>  
                      </tbody>
                  </table>
